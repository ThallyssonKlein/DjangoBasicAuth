...
**Ps:** Needs Python3 + Pipenv. For reasons of Github security policies, I cannot keep the django secret exposed. For this code to work create a .env at the root of the directory and set DJANGO_SECRET=[your secret].
